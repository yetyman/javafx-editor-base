...
public class SampleBox implements EditorItem {
    ...
    public void initialize(EditorPane editor) {
        ...
        tl.location.set(new Point2D(-20, -20));
        br.location.set(new Point2D(20, 20));
        tr.location.set(new Point2D(20, -20));
        bl.location.set(new Point2D(-20, 20));

        anchors = List.of(tl, tr, br, bl, c, r);
        nodes = List.of(box);

        var trBind = tr.location.bindOut(s -> {
            cyclePrevent(() -> {
        ...
        var blBind = bl.location.bindOut(s -> {
            cyclePrevent(() -> {
        ...
        var cBind = c.location.bindOut((s, a, b) -> {
            cyclePrevent(() -> {
        ...
        var rBind = r.location.bindOut((s, a, b) -> {
            cyclePrevent(() -> {
